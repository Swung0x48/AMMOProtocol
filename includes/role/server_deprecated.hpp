#ifndef AMMOPROTOCOL_SERVER_DEPRECATED_HPP
#define AMMOPROTOCOL_SERVER_DEPRECATED_HPP
namespace ammo::role {
    template <typename T>
    class server_deprecated {
    protected:
...
#endif //AMMOPROTOCOL_SERVER_DEPRECATED_HPP
